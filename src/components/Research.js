      ...
      <section id="research">
        ...
        <div className="timeline">
          <div className="timeline-item">
            <PublicImage src="/logos/GRAPPA_logo.png" alt="AUTH Logo" className="research-logo" />
          ...
          <div className="timeline-item">
            <PublicImage src="/logos/auth_logo_bkg.png" alt="University of Amsterdam Logo" className="research-logo" />
            <div className="timeline-content">
